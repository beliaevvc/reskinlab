-- ===========================================
-- UPDATE AUTO TASK CREATION TO USE TEMPLATES
-- ===========================================

-- Обновляем функцию для использования шаблонов из task_auto_templates
  ...
  IF NEW.status = 'paid' AND (OLD.status IS NULL OR OLD.status != 'paid') THEN
    ...
    LOOP
      ...
      IF NOT FOUND THEN
        ...
        -- Определяем название и описание stage по stage_key
...
-- Комментарий
COMMENT ON FUNCTION auto_create_tasks_on_first_payment() IS 'Автоматически создает задачи из шаблонов и спецификации при подтверждении первой оплаты проекта';
