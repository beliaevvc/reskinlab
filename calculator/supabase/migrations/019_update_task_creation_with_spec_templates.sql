-- ===========================================
-- UPDATE TASK CREATION TO USE SPEC ITEM TEMPLATES
-- ===========================================

-- Обновляем функцию для использования шаблонов из task_spec_item_templates
-- и сохранения связи задач с пунктами спецификации
...
-- Комментарий
COMMENT ON FUNCTION auto_create_tasks_on_first_payment() IS 'Автоматически создает задачи из шаблонов и спецификации при подтверждении первой оплаты проекта. Использует шаблоны task_spec_item_templates для настройки названий задач';
