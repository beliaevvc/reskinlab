...
export function TaskFiles({ taskId, projectId }) {
  ...
  if (isLoading) {
    return (
      <div className="text-xs text-neutral-400">{t('common:loading', { defaultValue: 'Loading...' })}</div>
    );
  }
  ...
  return (
    <div className="space-y-2">
      <h5 className="text-xs font-medium text-neutral-500 flex items-center gap-1">
        ...
        {t('files.attachments', { count: files.length, defaultValue: `Attachments (${files.length})` })}
      </h5>
